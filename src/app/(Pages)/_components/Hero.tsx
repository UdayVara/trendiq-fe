  ...
  return (
    <div className="bg-gradient-to-r from-red-700 via-red-600 to-orange-500 text-white py-20">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 drop-shadow-lg">Discover Bold Fashion Statements</h1>
        <p className="text-xl mb-8 max-w-2xl mx-auto">Shop the latest styles in clothes, t-shirts, hoodies, and more on TrendIQ. Express your fierce style with our curated collection.</p>
